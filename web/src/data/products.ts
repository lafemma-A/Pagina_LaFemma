...
export const PRODUCTS: Product[] = [
    {
        ...
        specs: { material: 'Seda Italiana 100%', origin: 'Colombia', density: '19 Momme — Caída líquida', care: 'Lavado en seco' },
        sizes: ['XS', 'S', 'M', 'L'],
    },
    {
        id: 'arch-2',
        ...
        specs: { material: 'Organza de seda y tul', origin: 'Colombia', density: '12 Momme — Ultra ligero', care: 'Lavado a mano' },
        sizes: ['S', 'M', 'L'],
    },
    {
        id: 'arch-3',
        ...
        specs: { material: 'Lana merino con insertos metálicos', origin: 'Colombia', density: 'Alta — Estructura definida', care: 'Lavado en seco' },
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
    },
    {
        id: 'arch-4',
        ...
        specs: { material: 'Jersey de algodón orgánico', origin: 'Colombia', density: 'Media — Drapeado natural', care: 'Lavado a máquina' },
        sizes: ['S', 'M', 'L'],
    },
    {
        id: 'arch-5',
        ...
        specs: { material: 'Crepé de seda', origin: 'Colombia', density: '16 Momme — Fluido', care: 'Lavado en seco' },
        sizes: ['XS', 'S', 'M', 'L'],
    },
    {
        id: 'arch-6',
        ...
        specs: { material: 'Seda dupión con bordado artesanal', origin: 'Colombia', density: '22 Momme — Peso sustancial', care: 'Solo lavado en seco' },
        sizes: ['S', 'M', 'L'],
    },
    {
        id: 'arch-7',
        ...
        specs: { material: 'Terciopelo de seda', origin: 'Colombia', density: '18 Momme — Suavidad extrema', care: 'Lavado en seco' },
        sizes: ['XS', 'S', 'M', 'L'],
    },
    {
        id: 'arch-8',
        ...
        specs: { material: 'Gasa de seda multicapa', origin: 'Colombia', density: '8 Momme — Etéreo', care: 'Lavado a mano' },
        sizes: ['S', 'M', 'L', 'XL'],
    },
    {
        id: 'arch-9',
        ...
        specs: { material: 'Lana fría con corte láser', origin: 'Colombia', density: 'Alta — Estructura arquitectónica', care: 'Lavado en seco' },
        sizes: ['XS', 'S', 'M', 'L'],
    },
    {
        id: 'arch-10',
        ...
        specs: { material: 'Satén de algodón bicolor', origin: 'Colombia', density: 'Media — Equilibrio perfecto', care: 'Lavado a máquina' },
        sizes: ['S', 'M', 'L'],
    },
    {
        id: 'arch-11',
        ...
        specs: { material: 'Punto milano de viscosa', origin: 'Colombia', density: 'Media-alta — Estructura con elasticidad', care: 'Lavado a máquina' },
        sizes: ['XS', 'S', 'M', 'L', 'XL'],
    },
    {
        id: 'arch-12',
        ...
        specs: { material: 'Seda charmeuse con acabado artesanal', origin: 'Colombia', density: '25 Momme — Lujo absoluto', care: 'Solo lavado en seco' },
        sizes: ['S', 'M'],
    },
];
